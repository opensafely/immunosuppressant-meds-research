...
imr_fplot <- function(
  ...
  forestplot(
    ...
    col = fpColors(
      zero = "#707070",
      box = c("#C0C0C0", "black", "red4", "blue4"),
      summary = "#707070"
    ),
    fn.ci_norm = c(fpDrawCircleCI, fpDrawDiamondCI, fpDrawCircleCI, fpDrawCircleCI),
...
svg("output/figures/forest_plot_vs_gen_pop.svg", width = 12, height = 14)
imr_fplot(
  model_outputs,
  ...
  models = c("Minimally adjusted" = "agesex",
             "Fully adjusted" = "adjusted_main",
             "Confounder adjusted (IMID)" = "adjusted_imid_confou",
             "Mediator adjusted (IMID)" = "adjusted_imid_mediat"),
  # clip axis
  clip = c(0.7, 2),
...
imr_fplot(
  ...
  models = c("Minimally adjusted"="agesex",
             "Fully adjusted" = "adjusted_main",
             "Confounder adjusted (Drugs)" = "adjusted_drugs_confo",
             "Mediator adjusted (Drugs)"="adjusted_drugs_media"),
