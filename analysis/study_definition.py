...
#    ),
    ...
    **medication_counts_and_dates("aflibercept", "opensafely-high-cost-drugs-aflibercept", True),
    **medication_counts_and_dates("alemtuzumab", "opensafely-high-cost-drugs-alemtuzumab", True),
    **medication_counts_and_dates("anakinra", "opensafely-high-cost-drugs-anakinra", True),
    **medication_counts_and_dates("baricitinib", "opensafely-high-cost-drugs-baricitinib", True),
    **medication_counts_and_dates("belimumab", "opensafely-high-cost-drugs-belimumab", True),
    **medication_counts_and_dates("benralizumab", "opensafely-high-cost-drugs-benralizumab", True),
    ...
    **medication_counts_and_dates("natalizumab", "opensafely-high-cost-drugs-natalizumab", True),
    **medication_counts_and_dates("ocrelizumab", "opensafely-high-cost-drugs-ocrelizumab", True),
    **medication_counts_and_dates("omalizumab", "opensafely-high-cost-drugs-omalizumab", True),
    **medication_counts_and_dates("ranibizumab", "opensafely-high-cost-drugs-ranibizumab", True),
    **medication_counts_and_dates("reslizumab", "opensafely-high-cost-drugs-reslizumab", True),
