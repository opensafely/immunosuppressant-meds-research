...
use "/Users/gallowaywork/Dropbox/immunosuppressant-meds-research/output/data/file_imid.dta", clear
/*==============================================================================
...
bys ethnicity male: egen totalpop = total(patient_id)
...
foreach l in `r(levels)' {
	...
	twoway (bar percentage agegroup if sex=="M" & ethnicity==`l', horizontal bfcolor(gs12) blcolor(gs1)) ///
	(bar percentage agegroup if sex=="F" & ethnicity==`l', horizontal bfcolor(gs12) blcolor(gs1))	///
